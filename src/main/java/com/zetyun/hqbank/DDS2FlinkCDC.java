...
//
//            // 对每条数据进行反序列化和处理
//            DataStream<Object> processedStream = sourceStream.flatMap((FlatMapFunction<String, Object>) (s, collector) -> {
//                List<String> test = processData(s, "test");
...
//                    return ddsPayload.getOp();
//                    // Return the key for partitioning
//                }
...
//
//
//    public static List<String> processData(String input, String schema) {
...
//            try {
//                result.add(om.writeValueAsString(dummy));
//                return result;
...
//                    result.add(om.writeValueAsString(payload)) ;
//                    return result;
//                } catch (Exception e) {
